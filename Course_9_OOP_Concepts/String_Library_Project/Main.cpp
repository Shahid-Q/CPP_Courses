...

{
    ...
    clsString String2("Shahid");

    String1.Value = "Shahid Lili";
    ...
    cout << "Number of words: " << String1.CountWords("Fadi ahmed retaj loi") << endl;

    cout << "Number of words: " <<
        clsString::CountWords("Life is beautiful") << endl;
    ...
    cout << "Capital Letters count : "
        << clsString::CountLetters("I love peace", clsString::CapitalLetters)
        << endl << endl;
    ...
    //Tirms
    String3.Value = "    Lilia Nai Kolay Jolia     ";
    ...
    //Joins
    vector<string> vString1 = { " Lilia Nai Kolay Jolia " };

    cout << "\n\nJoin String From Vector: \n";
    cout << clsString::JoinString(vString1, " ");


    string arrString[] = { "Lilia","Nai","Kolay","Jolia" };
    ...
    String3.Value = "Lilia Nai Kolay Jolia";
    cout << "\nReplace : " << String3.ReplaceWord("Kolay", "Loy") // Write Loy instead of of Kolay
        << endl;
